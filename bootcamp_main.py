...
def main() -> int:
    ...
    if not result:
        ...
        return -1
    if heartbeat_sender_properties is None:
        print("Heartbeat Sender properties unexpectedly None")
        return -1
    ...
    if not result:
        ...
        return -1
    if heartbeat_receiver_properties is None:
        print("Heartbeat Receiver properties unexpectedly None")
        return -1
    ...
    if not result:
        ...
        return -1
    if telemetry_properties is None:
        print("Telemetry properties unexpectedly None")
        return -1
    ...
    if not result:
        ...
        return -1
    if command_properties is None:
        print("Command properties unexpectedly None")
        return -1
    ...
    if not result:
        ...
        return -1
    if heartbeat_sender_manager is None:
        print("Heartbeat Sender manager unexpectedly None")
        return -1
    ...
    if not result:
        ...
        return -1
    if heartbeat_receiver_manager is None:
        print("Heartbeat Receiver manager unexpectedly None")
        return -1
    ...
    if telemetry_manager is None:
        print("Telemetry manager unexpectedly None")
        return -1
    ...
    if command_manager is None:
        print("Command manager unexpectedly None")
        return -1
    ...
    disconnected = False
    while time.time() - start_time < MAIN_RUNTIME_SECONDS and not disconnected:
        try:
            heartbeat_state = heartbeat_to_main_queue.queue.get(timeout=0.1)
            main_logger.info(f"Heartbeat receiver output: {heartbeat_state}", True)
